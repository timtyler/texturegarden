...
public class SAXDriverBuffer extends Writer {

  private SAXDriver sd;
  ...
  public SAXDriverBuffer(final Reader in, SAXDriver sd) {
    this.in = in;
    this.sd = sd;
  ...
  public void setSd(SAXDriver sd) {
    this.sd = sd;
  }

  public SAXDriver getSd() {
    return sd;
  }
}
