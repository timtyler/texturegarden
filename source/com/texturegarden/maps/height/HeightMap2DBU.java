...
public class HeightMap2DBU {
  ...
  // two levels...
  public static void heightMapRenderRD(ImageWrapper tti, SimpleArray2D s_a, int range1, int range2, Texture t, boolean hflip, boolean vflip) {
    t.program.claimTexture(t);
    texture = t;
    program = t.program;
